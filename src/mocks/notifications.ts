...
let notifications: NotificationDto[] = [
  ...
  { id: 'n3', type: 3, title: 'Новая закупка', message: 'Приход по заказу PO-2026-0118 от «Nestle Uzbekistan» подтверждён.', createdAt: '2026-08-18T13:05:00Z', isRead: true },
  { id: 'n4', type: 4, title: 'Изменение цены', message: 'Цена «Кока-Кола 0.5л» изменена: 14 000 → 15 000 сум.', createdAt: '2026-08-18T10:22:00Z', isRead: true },
  { id: 'n5', type: 5, title: 'Финансовое событие', message: 'Расход «Аренда помещения» — 2 400 000 сум списан со счёта «Расчётный счёт».', createdAt: '2026-08-18T08:00:00Z', isRead: true },
